...
const ViewQuotation = (props) => {
	...
	const downloadPDF = () => {
		...
		doc.text(280, 470, quotation.terms);
		...
		doc.setFont("Helvertica", "bold");
		doc.setTextColor("Blue");
		doc.text(50, 100, "Quotation Items Details");
										...
										<Col md="6">
											<FormGroup>
												<label>
													...
													{quotation.event_id &&
														quotation.provider_id.user_name}{" "}
												</label>
												<label className="ml-3"> </label>
											</FormGroup>
										</Col>
										<Col md="6">
											<FormGroup>
												<label>
													Service Type :{" "}
													{quotation.event_id &&
														quotation.provider_id.service_type}{" "}
												</label>
												<label className="ml-3"> </label>
											</FormGroup>
										</Col>
										...
										<Col md="6">
											<FormGroup>
												<label>
													...
													{quotation.event_id && quotation.provider_id.email}
												</label>
												<label className="ml-3"></label>
											</FormGroup>
										</Col>
										<Col md="6">
											<FormGroup>
												<label>
													...
													{quotation.event_id && quotation.provider_id.mobile}
												</label>
												<label className="ml-3"> </label>
											</FormGroup>
										</Col>
